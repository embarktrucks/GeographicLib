...
const NormalGravity& NormalGravity::WGS84() {
    static const NormalGravity wgs84(
        Constants::WGS84_a(), Constants::WGS84_GM(), Constants::WGS84_omega(),
...
const NormalGravity& NormalGravity::GRS80() {
    static const NormalGravity grs80(
        Constants::GRS80_a(), Constants::GRS80_GM(), Constants::GRS80_omega(),
...
Math::real NormalGravity::J2ToFlattening(real a, real GM, real omega, real J2) {
    ...
    real ep2 = max(Math::sq(32 * K / (3 * Math::sq(Math::pi()) * (J0 - J2))),
                   -maxe_),
