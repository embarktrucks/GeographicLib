...
Math::real Geodesic::GenInverse(real lat1, real lon1, real lat2, real lon2,
  ...
  if (meridian) {
                  ...
                  csig1 * csig2 + ssig1 * ssig2);
    {
      ...
      Lengths(_n, sig12, ssig1, csig1, dn1, ssig2, csig2, dn2, cbet1, cbet2,
              outmask | DISTANCE | REDUCEDLENGTH, s12x, m12x, dummy, M12, M21,
              Ca);
    }
  ...
  if (!meridian && sbet1 == 0 &&  // and sbet2 == 0
    ...
    real dnm;
    sig12 = InverseStart(sbet1, cbet1, dn1, sbet2, cbet2, dn2, lam12, slam12,
    ...
    if (sig12 >= 0) {
      ...
      for (bool tripn = false, tripb = false;
        ...
        real v = Lambda12(sbet1, cbet1, dn1, sbet2, cbet2, dn2, salp1, calp1,
                          ...
                          ssig2, csig2, eps, domg12, numit < maxit1_, dv, Ca);
      ...
      }
      {
        ...
        Lengths(eps, sig12, ssig1, csig1, dn1, ssig2, csig2, dn2, cbet1, cbet2,
                lengthmask, s12x, m12x, dummy, M12, M21, Ca);
      }
      m12x *= _b;
      s12x *= _b;
      a12 = sig12 / Math::degree();
...
Math::real Geodesic::InverseStart(real sbet1, real cbet1, real dn1, real sbet2,
  ...
  if (shortline && ssig12 < _etol2) {
    ...
    if (_f >= 0) {                          // In fact f == 0 does not get here
      ...
      // Inverse.
      Lengths(_n, Math::pi() + bet12a, sbet1, -cbet1, dn1, sbet2, cbet2, dn2,
...
Math::real Geodesic::Lambda12(real sbet1, real cbet1, real dn1, real sbet2,
  ...
  if (diffp) {
    if (calp2 == 0)
      ...
      real dummy;
      Lengths(eps, sig12, ssig1, csig1, dn1, ssig2, csig2, dn2, cbet1, cbet2,
              REDUCEDLENGTH, dummy, dlam12, dummy, dummy, dummy, Ca);
