 ...
 * \brief Header for geographic_lib::GravityModel class
 *
...
namespace geographic_lib {
  ...
  public:
     ...
     * (/usr/local/share/geographic_lib/gravity on non-Windows systems and
     * C:/ProgramData/geographic_lib/gravity on Windows systems).
     **********************************************************************/
