/**
 * \file Constants.hpp
 * \brief Header for geographic_lib::Constants class
 *
...
/**
 * @relates geographic_lib::Constants
...
/**
 * @relates geographic_lib::Constants
 * The version of geographic_lib as a single integer, packed as MMmmmmpp where
...
#  elif defined(geographic_lib_EXPORTS)
...
/**
 * \brief Namespace for %geographic_lib
 *
 * All of %geographic_lib is defined within the geographic_lib namespace.  In
 * addition all the header files are included via %geographic_lib/Class.hpp.
 * This minimizes the likelihood of conflicts with other packages.
 **********************************************************************/
namespace geographic_lib {

  /**
   * \brief %Constants needed by %geographic_lib
   *
  ...
  /**
   * \brief Exception handling for %geographic_lib
   *
