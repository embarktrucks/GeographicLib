 ...
 * \brief Header for geographic_lib::MagneticModel class
 *
...
namespace geographic_lib {
  ...
  public:
     ...
     * (/usr/local/share/geographic_lib/magnetic on non-Windows systems and
     * C:/ProgramData/geographic_lib/magnetic on Windows systems).
     **********************************************************************/
