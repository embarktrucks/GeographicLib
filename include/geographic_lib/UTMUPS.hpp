/**
 * \file UTMUPS.hpp
 * \brief Header for geographic_lib::UTMUPS class
 *
...
namespace geographic_lib {
   ...
   * geographic_lib:TransverseMercator and geographic_lib:PolarStereographic.
   ...
   *
   * The geographic_lib::UTMUPS::EncodeZone encodes the UTM zone and hemisphere
  ...
  public:
     ...
     * \code
     ...
     bool northp;
     double x, y, gamma, k;
     geographic_lib::UTMUPS::Forward(lat, lon, zone, northp, x, y, gamma, k);
     geographic_lib::UTMUPS::Transfer(zone, northp, x, y,
                                     zone, true,   x, y, zone);
     northp = true;
     \endcode
     **********************************************************************/
