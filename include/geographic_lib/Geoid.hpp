/**
 * \file Geoid.hpp
 * \brief Header for geographic_lib::Geoid class
 *
...
namespace geographic_lib {
  ...
  public:
     ...
     * default (/usr/local/share/geographic_lib/geoids on non-Windows systems
     * and C:/ProgramData/geographic_lib/geoids on Windows systems).
     **********************************************************************/
