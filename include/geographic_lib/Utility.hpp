/**
 * \file Utility.hpp
 * \brief Header for geographic_lib::Utility class
 *
...
namespace geographic_lib {
  ...
  /**
   * \brief Some utility routines for %geographic_lib
   *
   * Example of use:
  ...
  public:
     ...
     * geographic_lib functions.  (Several functions, for example Math::pi(),
