 ...
 * \brief Header for geographic_lib::PolygonAreaT class
 *
...
namespace geographic_lib {
   ...
   * GeodesicExact, and Rhumb.  geographic_lib::PolygonArea,
   * geographic_lib::PolygonAreaExact, and geographic_lib::PolygonAreaRhumb are
