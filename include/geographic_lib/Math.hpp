/**
 * \file Math.hpp
 * \brief Header for geographic_lib::Math class
 *
...
/**
 * The precision of floating point numbers used in %geographic_lib.  1 means
...
#define GEOGRAPHICLIB_PANIC \
  (throw geographic_lib::GeographicErr("Convergence failure"), false)
#else
...
namespace geographic_lib {
  ...
  /**
   * \brief Mathematical functions needed by %geographic_lib
   *
   ...
   * type to be used by %geographic_lib.
   *
   * Example of use:
  ...
  public:
    ...
    /**
     * The real type for %geographic_lib. Nearly all the testing has been done
