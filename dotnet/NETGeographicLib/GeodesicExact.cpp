...
GeodesicExact::GeodesicExact() {
  try {
    m_pGeodesicExact =
      new GeographicLib::GeodesicExact(GeographicLib::GeodesicExact::WGS84());
...
double GeodesicExact::Direct(
  ...
  double out = m_pGeodesicExact->Direct(lat1, lon1, azi1, s12, llat2, llon2,
...
double GeodesicExact::Direct(
  ...
  double out =
    m_pGeodesicExact->Direct(lat1, lon1, azi1, s12, llat2, llon2, lazi2);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
  return out;
...
double GeodesicExact::Direct(
  ...
  double out =
    m_pGeodesicExact->Direct(lat1, lon1, azi1, s12, llat2, llon2, lazi2, lm12);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
  m12 = lm12;
...
void GeodesicExact::ArcDirect(
  ...
  m_pGeodesicExact->ArcDirect(lat1, lon1, azi1, a12, llat2, llon2, lazi2, ls12,
                              lm12, lM12, lM21, lS12);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
...
void GeodesicExact::ArcDirect(double lat1, double lon1, double azi1, double a12,
                              ...
                              [System::Runtime::InteropServices::Out] double %
                                lon2) {
  double llat2, llon2;
  m_pGeodesicExact->ArcDirect(lat1, lon1, azi1, a12, llat2, llon2);
  lat2 = llat2;
  lon2 = llon2;
}
...
void GeodesicExact::ArcDirect(
  ...
  [System::Runtime::InteropServices::Out] double % azi2) {
  double llat2, llon2, lazi2;
  m_pGeodesicExact->ArcDirect(lat1, lon1, azi1, a12, llat2, llon2, lazi2);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
}
...
//*****************************************************************************
double GeodesicExact::GenDirect(
  ...
  [System::Runtime::InteropServices::Out] double % S12) {
  double llat2, llon2, lazi2, ls12, lm12, lM12, lM21, lS12;
  double out = m_pGeodesicExact->GenDirect(
    lat1, lon1, azi1, arcmode, s12_a12, static_cast<unsigned>(outmask), llat2,
    llon2, lazi2, ls12, lm12, lM12, lM21, lS12);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
  s12 = ls12;
...
double GeodesicExact::Inverse(
  ...
  double out = m_pGeodesicExact->Inverse(lat1, lon1, lat2, lon2, ls12, lazi1,
                                         lazi2, lm12, lM12, lM21, lS12);
  s12 = ls12;
  azi1 = lazi1;
  azi2 = lazi2;
...
//*****************************************************************************
double GeodesicExact::Inverse(double lat1, double lon1, double lat2,
                              double lon2,
                              [System::Runtime::InteropServices::Out] double %
                                s12) {
  double ls12;
...
double GeodesicExact::Inverse(
  ...
  [System::Runtime::InteropServices::Out] double % azi2) {
  double lazi1, lazi2;
  double out = m_pGeodesicExact->Inverse(lat1, lon1, lat2, lon2, lazi1, lazi2);
  azi1 = lazi1;
  azi2 = lazi2;
  return out;
}
...
double GeodesicExact::Inverse(
  ...
  double out =
    m_pGeodesicExact->Inverse(lat1, lon1, lat2, lon2, ls12, lazi1, lazi2);
  s12 = ls12;
  azi1 = lazi1;
  azi2 = lazi2;
  return out;
...
double GeodesicExact::Inverse(
  ...
  double out =
    m_pGeodesicExact->Inverse(lat1, lon1, lat2, lon2, ls12, lazi1, lazi2, lm12);
  s12 = ls12;
  azi1 = lazi1;
  azi2 = lazi2;
  m12 = lm12;
...
//*****************************************************************************
double GeodesicExact::GenInverse(
  double lat1, double lon1, double lat2, double lon2,
  GeodesicExact::mask outmask,
  [System::Runtime::InteropServices::Out] double % s12,
  [System::Runtime::InteropServices::Out] double % azi1,
  ...
  [System::Runtime::InteropServices::Out] double % S12) {
  double ls12, lazi1, lazi2, lm12, lM12, lM21, lS12;
  double out = m_pGeodesicExact->GenInverse(
    lat1, lon1, lat2, lon2, static_cast<unsigned>(outmask), ls12, lazi1, lazi2,
    lm12, lM12, lM21, lS12);
  s12 = ls12;
  azi1 = lazi1;
  azi2 = lazi2;
...
System::IntPtr ^ GeodesicExact::GetUnmanaged() {
  return gcnew System::IntPtr(
    const_cast<void*>(reinterpret_cast<const void*>(m_pGeodesicExact)));
}
