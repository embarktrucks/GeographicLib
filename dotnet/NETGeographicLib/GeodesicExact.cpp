...
GeodesicExact::GeodesicExact() {
    try {
        m_pGeodesicExact = new GeographicLib::GeodesicExact(
            GeographicLib::GeodesicExact::WGS84());
...
double GeodesicExact::Inverse(
    ...
    double lazi1, lazi2;
    double out =
        m_pGeodesicExact->Inverse(lat1, lon1, lat2, lon2, lazi1, lazi2);
    azi1 = lazi1;
    azi2 = lazi2;
    return out;
}
...
double GeodesicExact::GenInverse(
    ...
    double out = m_pGeodesicExact->GenInverse(
        lat1, lon1, lat2, lon2, static_cast<unsigned>(outmask), ls12, lazi1,
        lazi2, lm12, lM12, lM21, lS12);
    s12 = ls12;
    azi1 = lazi1;
    azi2 = lazi2;
