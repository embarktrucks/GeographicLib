 ...
 *   <a
 *href="http://earth-info.nga.mil/GandG/publications/tm8358.2/TM8358_2.pdf"> The
 *Universal Grids: Universal Transverse Mercator (UTM) and Universal Polar
 *Stereographic (UPS)</a>, Defense Mapping Agency, Technical Manual TM8358.2
 *(1989).
 * .
...
ref class UTMUPS {
 ...
 public:
    ...
    enum class ZoneSpec {
         ...
         *zone to each pole to give a zone number in [1, 60].  For example, use
         *UTM zone 38 for longitude in [42&deg;, 48&deg;).  The rules include
         ...
         * tests on latitudes and longitudes are all closed on the lower end
         *open on the upper.  Thus for UTM zone 38, latitude is in
         *[&minus;80&deg;, 84&deg;) and longitude is in [42&deg;, 48&deg;).
         **********************************************************************/
        STANDARD = -1,
        /**
    ...
    static void DecodeZone(System::String ^ zonestr,
                           [System::Runtime::InteropServices::Out] int % zone,
                           [System::Runtime::InteropServices::Out] bool %
                               northp);
