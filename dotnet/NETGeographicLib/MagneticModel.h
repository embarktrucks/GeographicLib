...
ref class MagneticModel {
 ...
 public:
     ...
     **********************************************************************/
    ~MagneticModel() { this->!MagneticModel(); }
    ...
    property System::String ^
         ...
         **********************************************************************/
        property System::String ^
        MagneticModelName { System::String ^ get(); }

        /**
         * @return directory used to load the magnetic model.
         **********************************************************************/
        property System::String ^
        MagneticModelDirectory { System::String ^ get(); }
