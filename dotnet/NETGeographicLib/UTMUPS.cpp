...
void UTMUPS::Forward(double lat, double lon,
  ...
  try {
    ...
    GeographicLib::UTMUPS::Forward(lat, lon, lzone, lnorthp, lx, ly, lgamma, lk,
                                   setzone, mgrslimits);
    zone = lzone;
    northp = northp;
    x = lx;
...
void UTMUPS::Reverse(int zone, bool northp, double x, double y,
  ...
  try {
    ...
    GeographicLib::UTMUPS::Reverse(zone, northp, x, y, llat, llon, lgamma, lk,
                                   mgrslimits);
    lat = llat;
    lon = llon;
    gamma = lgamma;
...
void UTMUPS::Forward(double lat, double lon,
  ...
  try {
    ...
    bool lnorthp;
    int lzone;
    GeographicLib::UTMUPS::Forward(lat, lon, lzone, lnorthp, lx, ly, gamma, k,
                                   setzone, mgrslimits);
    x = lx;
    y = ly;
    zone = lzone;
...
void UTMUPS::Reverse(int zone, bool northp, double x, double y,
  ...
  try {
    ...
    GeographicLib::UTMUPS::Reverse(zone, northp, x, y, llat, llon, gamma, k,
                                   mgrslimits);
    lat = llat;
    lon = llon;
  } catch (const std::exception& err) {
...
void UTMUPS::Transfer(int zonein, bool northpin, double xin, double yin,
  ...
  try {
    int lzone;
    double lxout, lyout;
    GeographicLib::UTMUPS::Transfer(zonein, northpin, xin, yin, zoneout,
                                    northpout, lxout, lyout, lzone);
    xout = lxout;
    yout = lyout;
    zone = lzone;
  } catch (const std::exception& err) {
...
System::String ^ UTMUPS::EncodeZone(int zone, bool northp, bool abbrev) {
  try {
    return StringConvert::UnmanagedToManaged(
      GeographicLib::UTMUPS::EncodeZone(zone, northp, abbrev));
  } catch (const std::exception& err) {
    throw gcnew GeographicErr(err.what());
  }
}
