...
//*****************************************************************************
void MGRS::Forward(int zone, bool northp, double x, double y, int prec,
...
void MGRS::Reverse(System::String ^ mgrs,
  ...
  try {
    ...
    int lzone, lprec;
    bool lnorthp;
    GeographicLib::MGRS::Reverse(StringConvert::ManagedToUnmanaged(mgrs), lzone,
                                 lnorthp, lx, ly, lprec, centerp);
    x = lx;
    y = ly;
    zone = lzone;
    prec = lprec;
