...
//*****************************************************************************
LambertConformalConic::LambertConformalConic(double a, double f, double stdlat1,
                                             double stdlat2, double k1) {
    try {
        m_pLambertConformalConic = new GeographicLib::LambertConformalConic(
            a, f, stdlat1, stdlat2, k1);
    } catch (std::bad_alloc) {
        throw gcnew GeographicErr(BADALLOC);
    } catch (const std::exception& err) {
        throw gcnew GeographicErr(err.what());
...
//*****************************************************************************
LambertConformalConic::LambertConformalConic(double a, double f, double sinlat1,
                                             double coslat1, double sinlat2,
...
//*****************************************************************************
void LambertConformalConic::Forward(
...
//*****************************************************************************
void LambertConformalConic::Reverse(
