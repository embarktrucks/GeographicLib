...
GeodesicLine::GeodesicLine(Geodesic ^ g, double lat1, double lon1, double azi1,
  ...
  try {
    ...
    m_pGeodesicLine = new GeographicLib::GeodesicLine(
      *pGeodesic, lat1, lon1, azi1, static_cast<unsigned>(caps));
  } catch (std::bad_alloc) {
...
GeodesicLine::GeodesicLine(double lat1, double lon1, double azi1,
  ...
  try {
    m_pGeodesicLine =
      new GeographicLib::GeodesicLine(GeographicLib::Geodesic::WGS84(), lat1,
                                      lon1, azi1, static_cast<unsigned>(caps));
  } catch (std::bad_alloc) {
    throw gcnew GeographicErr(BADALLOC);
  }
}
...
//*****************************************************************************
double GeodesicLine::Position(
  double s12, [System::Runtime::InteropServices::Out] double % lat2,
  ...
  double out =
    m_pGeodesicLine->Position(s12, llat2, llon2, lazi2, lm12, lM12, lM21, lS12);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
  m12 = lm12;
...
double GeodesicLine::Position(
  ...
  double out = m_pGeodesicLine->Position(s12, llat2, llon2, lazi2, lM12, lM21);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
  M12 = lM12;
...
double GeodesicLine::Position(
  ...
  double out =
    m_pGeodesicLine->Position(s12, llat2, llon2, lazi2, lm12, lM12, lM21);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
  m12 = lm12;
...
//*****************************************************************************
void GeodesicLine::ArcPosition(
  double a12, [System::Runtime::InteropServices::Out] double % lat2,
  [System::Runtime::InteropServices::Out] double % lon2,
  [System::Runtime::InteropServices::Out] double % azi2,
  [System::Runtime::InteropServices::Out] double % s12,
  [System::Runtime::InteropServices::Out] double % m12,
  ...
  m_pGeodesicLine->ArcPosition(a12, llat2, llon2, lazi2, ls12, lm12, lM12, lM21,
                               lS12);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
...
void GeodesicLine::ArcPosition(
  ...
  m_pGeodesicLine->ArcPosition(a12, llat2, llon2, lazi2, ls12, lM12, lM21);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
  s12 = ls12;
...
void GeodesicLine::ArcPosition(
  ...
  m_pGeodesicLine->ArcPosition(a12, llat2, llon2, lazi2, ls12, lm12, lM12,
                               lM21);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
...
//*****************************************************************************
double GeodesicLine::GenPosition(
  bool arcmode, double s12_a12, GeodesicLine::mask outmask,
  ...
  [System::Runtime::InteropServices::Out] double % S12) {
  double llat2, llon2, lazi2, ls12, lm12, lM12, lM21, lS12;
  double out = m_pGeodesicLine->GenPosition(
    arcmode, s12_a12, static_cast<unsigned>(outmask), llat2, llon2, lazi2, ls12,
    lm12, lM12, lM21, lS12);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
...
//*****************************************************************************
double GeodesicLine::Flattening::get() { return m_pGeodesicLine->Flattening(); }

//*****************************************************************************
double GeodesicLine::Distance::get() { return m_pGeodesicLine->Distance(); }

//*****************************************************************************
double GeodesicLine::Arc::get() { return m_pGeodesicLine->Arc(); }
...
//*****************************************************************************
void GeodesicLine::SetArc(double a13) { m_pGeodesicLine->SetArc(a13); }
