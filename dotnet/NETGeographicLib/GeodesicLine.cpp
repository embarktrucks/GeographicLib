...
double GeodesicLine::Position(
    ...
    double out = m_pGeodesicLine->Position(s12, llat2, llon2, lazi2, lm12, lM12,
                                           lM21, lS12);
    lat2 = llat2;
    lon2 = llon2;
    azi2 = lazi2;
...
double GeodesicLine::Position(
    ...
    double out =
        m_pGeodesicLine->Position(s12, llat2, llon2, lazi2, lM12, lM21);
    lat2 = llat2;
    lon2 = llon2;
    azi2 = lazi2;
    M12 = lM12;
...
double GeodesicLine::GenPosition(
    ...
    double out = m_pGeodesicLine->GenPosition(
        arcmode, s12_a12, static_cast<unsigned>(outmask), llat2, llon2, lazi2,
