...
double Geodesic::Direct(double lat1, double lon1, double azi1, double s12,
  ...
  double out =
    m_pGeodesic->Direct(lat1, lon1, azi1, s12, llat2, llon2, lazi2, lM12, lM21);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
  M12 = lM12;
...
void Geodesic::ArcDirect(double lat1, double lon1, double azi1, double a12,
  ...
  m_pGeodesic->ArcDirect(lat1, lon1, azi1, a12, llat2, llon2, lazi2, ls12, lm12,
                         lM12, lM21, lS12);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
...
double Geodesic::GenDirect(
  ...
  Geodesic::mask outmask, [System::Runtime::InteropServices::Out] double % lat2,
  [System::Runtime::InteropServices::Out] double % lon2,
  [System::Runtime::InteropServices::Out] double % azi2,
  [System::Runtime::InteropServices::Out] double % s12,
  [System::Runtime::InteropServices::Out] double % m12,
...
double Geodesic::Inverse(double lat1, double lon1, double lat2, double lon2,
  ...
  double out = m_pGeodesic->Inverse(lat1, lon1, lat2, lon2, ls12, lazi1, lazi2,
                                    lm12, lM12, lM21, lS12);
  s12 = ls12;
  azi1 = lazi1;
  azi2 = lazi2;
