...
ref class GravityModel {
 ...
 public:
  ...
  property System::String ^
     ...
     **********************************************************************/
    property System::String ^
    GravityModelName { System::String ^ get(); }

    /**
     * @return directory used to load the gravity model.
     **********************************************************************/
    property System::String ^
    GravityModelDirectory { System::String ^ get(); }
   ...
   *
   * This is the value of the environment variable GEOGRAPHICLIB_GRAVITY_PATH,
   *if set; otherwise, it is $GEOGRAPHICLIB_DATA/gravity if the environment
   ...
   *
   * This is the value of the environment variable GEOGRAPHICLIB_GRAVITY_NAME,
   *if set, otherwise, it is "egm96".  The GravityModel class does not use
