 ...
 **********************************************************************/
public
ref class LambertConformalConic {
 private:
 ...
 public:
   ...
   **********************************************************************/
  LambertConformalConic(double a, double f, double stdlat1, double stdlat2,
                        double k1);
   ...
   **********************************************************************/
  LambertConformalConic(double a, double f, double sinlat1, double coslat1,
   ...
   **********************************************************************/
  ~LambertConformalConic() { this->!LambertConformalConic(); }
