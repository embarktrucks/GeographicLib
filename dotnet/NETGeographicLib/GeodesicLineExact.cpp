...
//*****************************************************************************
double GeodesicLineExact::Position(
  ...
  double out = m_pGeodesicLineExact->Position(s12, llat2, llon2, lazi2, lm12,
                                              lM12, lM21, lS12);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
...
double GeodesicLineExact::Position(
  ...
  double out =
    m_pGeodesicLineExact->Position(s12, llat2, llon2, lazi2, lM12, lM21);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
  M12 = lM12;
...
double GeodesicLineExact::Position(
  ...
  double out =
    m_pGeodesicLineExact->Position(s12, llat2, llon2, lazi2, lm12, lM12, lM21);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
  m12 = lm12;
...
//*****************************************************************************
void GeodesicLineExact::ArcPosition(
  ...
  m_pGeodesicLineExact->ArcPosition(a12, llat2, llon2, lazi2, ls12, lm12, lM12,
                                    lM21, lS12);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
...
void GeodesicLineExact::ArcPosition(
  ...
  m_pGeodesicLineExact->ArcPosition(a12, llat2, llon2, lazi2, ls12, lm12);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
  s12 = ls12;
...
void GeodesicLineExact::ArcPosition(
  ...
  m_pGeodesicLineExact->ArcPosition(a12, llat2, llon2, lazi2, ls12, lM12, lM21);
  lat2 = llat2;
  lon2 = llon2;
  azi2 = lazi2;
  s12 = ls12;
...
//*****************************************************************************
double GeodesicLineExact::GenPosition(
  bool arcmode, double s12_a12, GeodesicLineExact::mask outmask,
  ...
  [System::Runtime::InteropServices::Out] double % S12) {
  double llat2, llon2, lazi2, ls12, lm12, lM12, lM21, lS12;
  double out = m_pGeodesicLineExact->GenPosition(
...
//*****************************************************************************
double GeodesicLineExact::Arc::get() { return m_pGeodesicLineExact->Arc(); }

//*****************************************************************************
NETGeographicLib::Mask GeodesicLineExact::Capabilities() {
  return static_cast<NETGeographicLib::Mask>(
    m_pGeodesicLineExact->Capabilities());
}
...
//*****************************************************************************
void GeodesicLineExact::EquatorialAzimuthSinCos(double % sazi0,
                                                double % cazi0) {
  double x1, x2;
