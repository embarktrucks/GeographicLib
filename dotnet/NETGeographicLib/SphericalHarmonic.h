...
ref class SphericalHarmonic {
 ...
 public:
  ...
  enum class Normalization {
     ...
     *
     * These are defined by <i>P</i><sub><i>nm</i></sub><sup>full</sup>(\e
     *z) = (&minus;1)<sup><i>m</i></sup> sqrt(\e k (2\e n + 1) (\e n &minus;
     *\e m)! / (\e n + \e m)!)
     ...
     * associated Legendre polynomial) http://dlmf.nist.gov/14.7.E10 and \e
     *k = 1 for \e m = 0 and \e k = 2 otherwise.
     *
     ...
     *(&minus;1)<sup><i>m</i></sup> sqrt(\e k (\e n &minus; \e m)! /
     * (\e n + \e m)!)  <b>P</b><sub><i>n</i></sub><sup><i>m</i></sup>(\e
     *z), where <b>P</b><sub><i>n</i></sub><sup><i>m</i></sup>(\e z) is
     *Ferrers function (also known as the Legendre function on the cut or
     *the associated Legendre polynomial) http://dlmf.nist.gov/14.7.E10 and
   ...
   **********************************************************************/
  SphericalHarmonic(array<double> ^ C, array<double> ^ S, int N, double a,
                    Normalization norm);
   ...
   * SphericalHarmonic object.
   **********************************************************************/
  SphericalHarmonic(array<double> ^ C, array<double> ^ S, int N, int nmx,
                    int mmx, double a, Normalization norm);
