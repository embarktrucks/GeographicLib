...
ref class AlbersEqualArea {
 ...
 public:
    ...
    enum class StandardTypes {
        CylindricalEqualArea,  //!< cylindrical equal area projection (stdlat =
                               //!< 0, and \e k0 = 1)
        AzimuthalEqualAreaNorth,  //!< Lambert azimuthal equal area projection
                                  //!< (stdlat = 90&deg;, and \e k0 = 1)
        AzimuthalEqualAreaSouth   //!< Lambert azimuthal equal area projection
                                  //!< (stdlat = &minus;90&deg;, and \e k0 = 1)
    };
     ...
     *   opposite poles.
     **********************************************************************/
    AlbersEqualArea(double a, double f, double stdlat1, double stdlat2,
                    double k1);
     ...
     **********************************************************************/
    AlbersEqualArea(double a, double f, double sinlat1, double coslat1,
                    double sinlat2, double coslat2, double k1);
