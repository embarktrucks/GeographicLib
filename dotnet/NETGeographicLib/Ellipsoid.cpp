...
Ellipsoid::Ellipsoid() {
    try {
        m_pEllipsoid =
            new GeographicLib::Ellipsoid(GeographicLib::Ellipsoid::WGS84());
    } catch (std::bad_alloc) {
...
//*****************************************************************************
double Ellipsoid::MajorRadius::get() { return m_pEllipsoid->MajorRadius(); }

//*****************************************************************************
double Ellipsoid::MinorRadius::get() { return m_pEllipsoid->MinorRadius(); }
...
//*****************************************************************************
double Ellipsoid::Area::get() { return m_pEllipsoid->Area(); }

//*****************************************************************************
double Ellipsoid::Volume::get() { return m_pEllipsoid->Volume(); }

//*****************************************************************************
double Ellipsoid::Flattening::get() { return m_pEllipsoid->Flattening(); }
