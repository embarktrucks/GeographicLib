...
//*****************************************************************************
double GravityCircle::Gravity(
    double lon, [System::Runtime::InteropServices::Out] double % gx,
...
//*****************************************************************************
double GravityCircle::Disturbance(
    double lon, [System::Runtime::InteropServices::Out] double % deltax,
...
//*****************************************************************************
void GravityCircle::SphericalAnomaly(
    double lon, [System::Runtime::InteropServices::Out] double % Dg01,
...
//*****************************************************************************
double GravityCircle::T(double lon) { return m_pGravityCircle->T(lon); }

//*****************************************************************************
double GravityCircle::MajorRadius::get() {
    if (m_pGravityCircle->Init()) return m_pGravityCircle->MajorRadius();
    throw gcnew GeographicErr(
        "GravityCircle::MajorRadius failed because the GravityCircle is not "
        "initialized.");
}

//*****************************************************************************
double GravityCircle::Flattening::get() {
    if (m_pGravityCircle->Init()) return m_pGravityCircle->Flattening();
    throw gcnew GeographicErr(
        "GravityCircle::Flattening failed because the GravityCircle is not "
        "initialized.");
}

//*****************************************************************************
double GravityCircle::Latitude::get() {
    if (m_pGravityCircle->Init()) return m_pGravityCircle->Latitude();
    throw gcnew GeographicErr(
        "GravityCircle::Latitude failed because the GravityCircle is not "
        "initialized.");
}

//*****************************************************************************
double GravityCircle::Height::get() {
    if (m_pGravityCircle->Init()) return m_pGravityCircle->Height();
    throw gcnew GeographicErr(
        "GravityCircle::Height failed because the GravityCircle is not "
        "initialized.");
}
