 ...
 **********************************************************************/
public
ref class GeographicErr : public System::Exception {
 public:
  /**
...
ref class Constants {
 ...
 public:
  ...
  ref class WGS72 {
   ...
   public:
    //! The equatorial radius in meters.
    static property double MajorRadius {
      double get() { return m_MajorRadius; }
    }
    //! The flattening of the ellipsoid
    static property double Flattening {
      double get() { return m_Flattening; }
    }
    //! The gravitational constant in meters<sup>3</sup>/second<sup>2</sup>.
    static property double GravitationalConstant {
      double get() { return m_GravitationalConstant; }
    }
    //! The spin rate of the Earth in radians/second.
    static property double EarthRate {
      double get() { return m_EarthRate; }
    }
    //! The dynamical form factor (J2).
    static property double J2 {
      double get() { return m_J2; }
    }
  };
  ...
  ref class WGS84 {
   private:
    ...
    // The following value is used to maintain consistency with
    // GeographicLib.
