...
int main() {
  try {
    ...
    // E-mail to PROJ.4 list, "Analyzing the bumps in the EGM2008 geoid".
    // The longitude of the major axis is -15.  These are close to the
    // values given by Milan Bursa, Vladimira Fialova, "Parameters of the
    // Earth's tri-axial level ellipsoid", Studia Geophysica et Geodaetica
    // 37(1), 1-13 (1993):
    //
    ...
    cout << fixed << setprecision(1) << "Ellipsoid parameters: a = " << a
         << ", b = " << b << ", c = " << c << "\n"
         << setprecision(10) << "Quadrants: x = " << jc.x()
         << ", y = " << jc.y() << "\n";
